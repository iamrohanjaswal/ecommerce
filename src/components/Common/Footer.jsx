...
const Footer = () => {
  return (
   <footer className="border-1 border-gray-200 py-12">
    <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-6'>
        ...
        <div>
            ...
            <ul className="space-y-2 text-gray-600">
                ...
                <li>
                    <Link to="#" className="hover:text-gray-500">Women's's Top wear</Link>
                </li>
                <li>
        ...
        <div>
            ...
            <div className="flex itmes-center space-x-4 mb-6">
